...
// ΓöÇΓöÇ GET /downloads/install-windows.ps1 ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ GET /downloads/agent.js ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ GET /downloads/agent-package.json ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ GET /downloads/ ΓÇö index ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
router.get('/', (req, res) => {
...
<h2>Windows ΓÇö PowerShell (run as Administrator)</h2>
<pre>Set-ExecutionPolicy Bypass -Scope Process -Force; iwr ${serverURL}/downloads/install-windows.ps1 | iex</pre>

<h2>Direct Downloads</h2>
<ul>
  <li><a href="/downloads/install-windows.ps1">install-windows.ps1</a> ΓÇö Windows auto-installer</li>
  <li><a href="/downloads/agent.js">agent.js</a> ΓÇö Agent source</li>
  <li><a href="/downloads/agent-package.json">package.json</a> ΓÇö Dependencies</li>
  <li><a href="/downloads/NexusIT-Setup.exe">NexusIT-Setup.exe</a> ΓÇö Windows desktop app (76 MB)</li>
</ul>
</body></html>`);
});

// ΓöÇΓöÇ GET /downloads/NexusIT-Setup.exe ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ GET /downloads/ ΓÇö index page ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
router.get('/', (req, res) => {
